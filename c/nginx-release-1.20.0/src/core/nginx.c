 ...
 * ./auto/configure --prefix=/cygdrive/d/app/nginx-release-1.20.0 --with-http_ssl_module --with-http_realip_module --with-http_addition_module --with-http_xslt_module --with-http_sub_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_auth_request_module
 * https://github.com/y123456yz/reading-code-of-nginx-1.9.2/tree/master/nginx-1.9.2/src/core
 */
...
main(int argc, char *const *argv)
{
    ...
    // 获取参数和配置参数，比如命令nginx -v那么ngx_show_version就设置为1
