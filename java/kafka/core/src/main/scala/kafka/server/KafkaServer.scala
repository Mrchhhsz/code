...
class KafkaServer(
  ...
  /**
   *  todo advertised.listeners参数的作用就是讲Broker的listener信息发布到zookeeper中，供Clients (Producer/Consumer)使用。
