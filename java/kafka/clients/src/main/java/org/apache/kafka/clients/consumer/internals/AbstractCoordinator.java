...
public abstract class AbstractCoordinator implements Closeable {
     ...
     * todo ensureCoordinatorReady()中实现，主要的作用是发送FindCoordinatorRequest请求，并建立连接
     */
    protected synchronized boolean ensureCoordinatorReady(final Timer timer) {
        ...
        do {
            ...
            // todo 核心代码，找到GroupCoordinator，并建立链接
                    ...
                    synchronized (AbstractCoordinator.this) {
                        if (state != MemberState.PREPARING_REBALANCE) {
                            ...
                            if (joinResponse.isLeader()) {
                                // todo 所有的消费者都会发送JoinGroup，最终只有1个consumer被指定为Leader Consumer,
                                // 如果是leader consumer，他会调用
    ...
    // leader consumer 开始基于消费者线程数和topic的分区数，开始制定分区消费方案
