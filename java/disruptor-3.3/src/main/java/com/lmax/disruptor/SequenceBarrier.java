...
/**
 * 序号屏障：
 * 通过跟踪生产者的cursor和当前处理器依赖的sequence,来协调对共享数据结构的访问
 *
 * 主要目的
 * 1.协调消费者与生产者 和 消费者与消费者之间的速度
 * 2.保证消费者与生产者 和 消费者与消费者之间的可见性
