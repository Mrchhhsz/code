 ...
 *
 * WAL(write ahead logging) 预写日志的接口
 *  负责读写操作日志
 *
 * TxnLog使用追加的方式，把每次事务都记录在log中
 *
 * 每次事务： {@link org.apache.zookeeper.Transaction}: Header(事务头), Record（具体的事务信息）
 *
 *  客户端和服务端进行通信的时候： {@link org.apache.zookeeper.server.Request} 和 Response
 */
