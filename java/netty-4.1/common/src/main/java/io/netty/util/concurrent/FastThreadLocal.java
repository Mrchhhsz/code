 ...
 * @see ThreadLocal
 * ThreadLocal的一个变体，可以提供更高的线程访问性能，
 * 在一个数组中使用一个常数索引，代替ThreadLocal使用hashTable需要计算hashcode
 * 对访问非常频繁的时候
 * 线程必须是FastThreadLocalThread及其子类
 */
public class FastThreadLocal<V> {
    ...
    // 每个ftl有一个固定的index，该index表示在InternalThreadLocalMap中的位置
