 ...
 * </p>
 *
 * 用于构建Node的，对于不同的上下文都会生成一个DefaultNode
 * 相同资源将全局共享相同的{@link com.alibaba.csp.sentinel.slotchain.ProcessorSlotChain},无论在哪个上下文
 * 因此不同的上下文可以进入到同一个对象的NodeSelectorSlot.entry方法中
 *
...
public class NodeSelectorSlot extends AbstractLinkedProcessorSlot<Object> {
    ...
    /**
     * 相同的资源，但是context不同，分别新建DefaultNode，并以ContextName为Key
    ...
    public void entry(Context context, ResourceWrapper resourceWrapper, Object obj, int count, boolean prioritized, Object... args)
         ...
         * 处理resource name相同而context name不同的情况
         */
        // 获取节点
        DefaultNode node = map.get(context.getName());
        if (node == null) {
            synchronized (this) { // DCL加写时复制
