...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
	...
	protected Object getObjectFromFactoryBean(FactoryBean<?> factory, String beanName, boolean shouldPostProcess) {
		if (factory.isSingleton() && containsSingleton(beanName)) {
			synchronized (getSingletonMutex()) {
				...
				if (object == null) {
					object = doGetObjectFromFactoryBean(factory, beanName); // 会调用factoryBean的getObject()方法
	 ...
	 * @return the object obtained from the FactoryBean
	 * @throws BeanCreationException if FactoryBean object creation failed
	 * @see org.springframework.beans.factory.FactoryBean#getObject() 调用getObject创建对象
	 */
	private Object doGetObjectFromFactoryBean(FactoryBean<?> factory, String beanName) throws BeanCreationException {
		...
		if (object == null) {
			if (isSingletonCurrentlyInCreation(beanName)) { // 如果是正在创建的FactoryBean，还没能获得bean，就报错
