...
public abstract class AopProxyUtils {
	...
	static Class<?>[] completeProxiedInterfaces(AdvisedSupport advised, boolean decoratingProxy) {
		...
		if (!advised.isInterfaceProxied(SpringProxy.class)) { // 添加SpringProxy接口
			proxiedInterfaces.add(SpringProxy.class);
		}
		if (!advised.isOpaque() && !advised.isInterfaceProxied(Advised.class)) { // 添加通知
			proxiedInterfaces.add(Advised.class);
		}
		if (decoratingProxy && !advised.isInterfaceProxied(DecoratingProxy.class)) { // 添加DecoratingProxy接口
